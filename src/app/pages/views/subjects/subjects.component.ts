...
import { CreateSubjectDto } from './test';
...
export class SubjectsComponent implements OnInit {
  ...
  // collectDataCreateSubject(): CreateSubjectDto {
  //   let fd = new FormData();
  ...
  sendSubject: CreateSubjectDto;

  intiSendSubject() {
    this.sendSubject = {
      gradeId : this.newSubject.gradeId,
      stageId: this.newSubject.stageId,
      subjectName: this.newSubject.subjectName,
      index: +this.newSubject.index,
      subjectBranches: this.reqAdd.SubjectBranches,
      subjectMzhbs: this.reqAdd.SubjectMzhbs,
      subjectSections: this.reqAdd.SubjectSections
    }
  }
  ...
  createSubject() {
    ...
    this.intiSendSubject();
    this.HttpMethods.createSubject(this.sendSubject).subscribe(res => {
      console.log(res);
